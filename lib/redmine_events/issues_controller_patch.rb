          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                #{original_issue.custom_field_value(badly_wounded_number_custom_field).to_i > 0 ? ('<img style="padding-left: 2.0em;" src=\'/plugin_assets/redmine_events/images/arrow_red.png\' /><span style="padding-left: .6em;">'+pluralize(original_issue.custom_field_value(badly_wounded_number_custom_field), 'blessé')+' '+'grave'.pluralize(original_issue.custom_field_value(badly_wounded_number_custom_field).to_i)+(original_issue.custom_value_for(badly_wounded_number_custom_field).comment.present? ? " (#{original_issue.custom_value_for(badly_wounded_number_custom_field).comment})" : "" )+'</span><br/>').html_safe : ''}
                ...
                #{original_issue.custom_field_value(wounded_number_custom_field).to_i > 0 ? ('<img style="padding-left: 2.0em;" src=\'/plugin_assets/redmine_events/images/arrow_red.png\' /><span style="padding-left: .6em;">'+pluralize(original_issue.custom_field_value(wounded_number_custom_field), 'blessé')+(original_issue.custom_value_for(wounded_number_custom_field).comment.present? ? " (#{original_issue.custom_value_for(wounded_number_custom_field).comment})" : "" )+'</span><br/>').html_safe : ''}
